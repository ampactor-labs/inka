...
## 3. The Compiler Medium (`std/compiler/types.ka` & `infer.ka`)
...
## 4. Mentl's Intelligence (`std/compiler/mentl.ka` & `query.ka`)
...
## 5. DSP & External (`std/dsp/signal.ka` & `wasm.ka`)
