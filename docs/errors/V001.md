...
**Emitted by:** Phase C `verify_ledger` handler (spec 06 `Verify`)
...
Phase C–E ships the verification substrate without the SMT solver.
...
None required in Phase C–E. If you want early verification:
