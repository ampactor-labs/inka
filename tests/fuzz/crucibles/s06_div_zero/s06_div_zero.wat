(module
  ...
  (type $ft2 (func (param i32) (param i32) (result i32)))
  ...
  (table $fns 2 funcref)
  (elem $fns (i32.const 0) $risky $main)
  (global $risky_idx i32 (i32.const 0))
  (global $main_idx i32 (i32.const 1))
  (data (i32.const 4096) "\00\00\00\00\00\00\00\00")
  (global $risky i32 (i32.const 4096))
  (data (i32.const 4104) "\01\00\00\00\00\00\00\00")
  (global $main i32 (i32.const 4104))
  ;; fn risky reason: inferred from int literal
  (func $risky (param $__state i32) (param $d i32) (result i32) (local $state_tmp i32) (local $variant_tmp i32) (local $record_tmp i32) (local $scrut_tmp i32) (local $callee_closure i32) (local $alloc_size i32) (local $loop_i i32)
    (i32.const 100)
    (local.get $d)
    (i32.div_s)
  )
  ;; fn main reason: return of fn
  (func $main (param $__state i32) (result i32) (local $state_tmp i32) (local $variant_tmp i32) (local $record_tmp i32) (local $scrut_tmp i32) (local $callee_closure i32) (local $alloc_size i32) (local $loop_i i32) (local $call_12 i32)
    (global.get $risky)
    (local.set $call_12)
    (local.get $call_12)
    (i32.const 0)
    (local.get $call_12) (i32.load offset=0)
    (return_call_indirect (type $ft2))
  )
  (func $_start
